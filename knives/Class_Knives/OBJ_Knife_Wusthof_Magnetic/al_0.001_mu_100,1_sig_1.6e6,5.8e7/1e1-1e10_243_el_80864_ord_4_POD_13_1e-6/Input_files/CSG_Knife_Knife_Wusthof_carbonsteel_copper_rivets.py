...
geo = CSGeometry(r'GeoFiles/Knife_Wusthof.geo')
...
nmesh.SetMaterial(6, material_name[0])
...
nmesh.Save(r'VolFiles/CSG_Knife_Knife_Wusthof_carbonsteel_copper_rivets.vol')