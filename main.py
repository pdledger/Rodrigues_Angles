...
def main(directory,MaxOmega):
    ...
    # Determine the maximal and minimal angles from QR and QI
    MinAnglestoreRI, MaxAnglestoreRI = MinMaxthetafromQRQI(Frequencies,QRstore,QIstore,URstore, UIstore,MultRstore,MultIstore)
    ...
    # Determine the maximal and minimal angles from QRtilde and QI
    MinAnglestoreRtildeI, MaxAnglestoreRtildeI = MinMaxthetafromQRQI(Frequencies,QRtildestore,QIstore,URtildestore, UIstore,MultRtildestore,MultIstore)
