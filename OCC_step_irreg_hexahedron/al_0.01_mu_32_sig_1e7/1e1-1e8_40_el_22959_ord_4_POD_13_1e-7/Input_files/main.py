...
if __name__ == '__main__':
    ...
    filelist = ['OCC_step_irreg_hexahedron.py'] * 5
    ord = [4]
    cpu_list = [1]
    count = 0
    for file, p, c in zip(filelist, ord, cpu_list):
        ...
        output1 = main(order=p, geometry=file, use_OCC=True, use_parallel=True, cpus=c, use_POD=True, curve_degree=1, start_stop=(1,8,40))
        ...
        plt.loglog(output1['FrequencyArray'], Z_tilde_upper_bound, label=r'$\Delta(\Vert \tilde{\mathcal{Z}}\Vert)$')
