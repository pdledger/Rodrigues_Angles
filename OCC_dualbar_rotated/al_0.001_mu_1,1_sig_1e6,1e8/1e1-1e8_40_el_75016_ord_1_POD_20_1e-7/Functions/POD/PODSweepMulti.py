...
def PODSweepMulti(Object, Order, alpha, inorout, mur, sig, Array, PODArray, PODTol, PlotPod, CPUs, sweepname, SavePOD,
    ...
    if recoverymode is False:
        ...
        if compute_additional_terms is True:
            term1, term2, term3, term4, Z_upper_bound, Z_tilde_upper_bound = test_reg(Theta0Sol, fes2, Theta1Sols, 6, xivec, inout, epsi, alpha, PODArray, PODTensors, Integration_Order,
                                                                 mu_inv, sigma, N0)
            ...
            shutil.copy('sum_reg_terms_real.csv', f'Results/{sweepname}/Data/sum_reg_terms_real_POD.csv')
            shutil.copy('sum_reg_terms_imag.csv', f'Results/{sweepname}/Data/sum_reg_terms_imag_POD.csv')
            shutil.copy('Z_upper_bound.csv', f'Results/{sweepname}/Data/Z_upper_bound_POD.csv')
            shutil.copy('Z_tilde_upper_bound.csv', f'Results/{sweepname}/Data/Z_tilde_upper_bound_POD.csv')
