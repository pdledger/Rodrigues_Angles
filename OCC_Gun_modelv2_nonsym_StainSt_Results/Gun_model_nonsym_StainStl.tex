...
\begin{center}
$\begin{array}{cc}
\includegraphics[width=0.5\textwidth]{mu20/RealEigenvalues.pdf} &
\includegraphics[width=0.5\textwidth]{mu20/ImaginaryEigenvalues.pdf}
\end{array}$
\end{center}
\caption{Computed $\lambda_n(\tilde{\mathcal R})$ (left) and  $\lambda_n({\mathcal I})$ (right) for the toy gun with $\mu_r=20$ in the barrel. Notice that $\lambda_2({\mathcal I})= \lambda_3({\mathcal I})$ for $\omega \approx 6 \times 10^3$ rad/s,  $\lambda_1({\mathcal I}) = \lambda_2({\mathcal I})$ for  $\omega\approx 1\times 10^5$ rad/s and $\lambda_1(\tilde{\mathcal R})\approx \lambda_2(\tilde{\mathcal R})$ for $\omega\approx 1\times 10^3$ rad/s }
\end{figure}
...
\includegraphics[width=0.5\textwidth]{mu20/OCC_Gun_modelv2_nonsym_StainSt_N0I_den_al_0.01_20,1_sig_1e6,1e8_ord_5.pdf} 
\end{array}$
\end{center}
...
\includegraphics[width=0.5\textwidth]{mu20/OCC_Gun_modelv2_nonsym_StainSt_RI_den_al_0.01_20,1_sig_1e6,1e8_ord_5.pdf} 
\end{array}$
\end{center}
\caption{Toy gun with $\mu_r=20$ in the barrel.Left: Angle measures $d_R({\mathcal R}, {\mathcal I})$ and $d_F({\mathcal R}, {\mathcal I})/\sqrt{2}$ using the eigenvectors and $\theta(d_E({\mathcal R}, {\mathcal I}) $ and $\theta(d_C({\mathcal R} , {\mathcal I} ) $ without using  the eigenvectors Right: Normalising constants in  $\theta(d_E({\mathcal R}, {\mathcal I}))$ and $\theta(d_C({\mathcal R}, {\mathcal I}))$}
\end{figure}
...
\includegraphics[width=0.5\textwidth]{mu20/OCC_Gun_modelv2_nonsym_StainSt_Rtilde0I_den_al_0.01_20,1_sig_1e6,1e8_ord_5.pdf} 
\end{array}$
\end{center}
