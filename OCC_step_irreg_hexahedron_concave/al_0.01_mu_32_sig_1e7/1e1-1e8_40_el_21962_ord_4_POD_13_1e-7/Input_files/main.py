...
if __name__ == '__main__':
    ...
    filelist = ['OCC_step_irreg_hexahedron_concave.py'] * 5
    ord = [4]
    cpu_list = [1]
    count = 0
    for file, p, c in zip(filelist, ord, cpu_list):
        ...
        for ind, coeff in enumerate([1]):
            plt.loglog(output1['PODFrequencyArray'], np.abs(output1['PODTensorArray'][:, coeff].real), label=f'$|\mathcal{{R}}_{{{label_list[ind]}}}|, p={p}$', color=cols[count], marker=marks[count])
            plt.loglog(output1['PODFrequencyArray'], np.abs(sum_reg_terms_real[:, coeff].real), label=f'$|\Delta(\mathcal{{R}})_{{{label_list[ind]}}}|, p={p}$', linestyle='--', color=cols[count], marker=marks[count])
        plt.legend()
        plt.xlabel(r'$\omega$, [rad/s]')
        plt.ylabel(r'$|\mathcal{R}|_{12}$')
        ...
        marks = ['x', '+', '*', '^', '1']
        for ind, coeff in enumerate([1]):
            plt.loglog(output1['PODFrequencyArray'], np.abs(output1['PODTensorArray'][:, coeff].imag), label=f'$|\mathcal{{I}}_{{{label_list[ind]}}}|, p={p}$', color=cols[count], marker=marks[count])
            plt.loglog(output1['PODFrequencyArray'], np.abs(sum_reg_terms_imag[:, coeff].real), label=f'$|\Delta(\mathcal{{I}})_{{{label_list[ind]}}}|, p={p}$', linestyle='--', color=cols[count], marker=marks[count])
        plt.legend()
        plt.xlabel(r'$\omega$, [rad/s]')
        plt.ylabel(r'$|\mathcal{I}|_{12}$')
        ...
        for ind, coeff in enumerate([2]):
            plt.loglog(output1['PODFrequencyArray'], np.abs(output1['PODTensorArray'][:, coeff].real), label=f'$|\mathcal{{R}}_{{{label_list[ind-1]}}}|, p={p}$', color=cols[count], marker=marks[count])
            plt.loglog(output1['PODFrequencyArray'], np.abs(sum_reg_terms_real[:, coeff].real), label=f'$|\Delta(\mathcal{{R}})_{{{label_list[ind-1]}}}|, p={p}$', linestyle='--', color=cols[count], marker=marks[count])
        plt.legend()
        plt.xlabel(r'$\omega$, [rad/s]')
        plt.ylabel(r'$|\mathcal{R}|_{13}$')
        ...
        marks = ['x', '+', '*', '^', '1']
        for ind, coeff in enumerate([2]):
            plt.loglog(output1['PODFrequencyArray'], np.abs(output1['PODTensorArray'][:, coeff].imag), label=f'$|\mathcal{{I}}_{{{label_list[ind-1]}}}|, p={p}$', color=cols[count], marker=marks[count])
            plt.loglog(output1['PODFrequencyArray'], np.abs(sum_reg_terms_imag[:, coeff].real), label=f'$|\Delta(\mathcal{{I}})_{{{label_list[ind-1]}}}|, p={p}$', linestyle='--', color=cols[count], marker=marks[count])
        plt.legend()
        plt.xlabel(r'$\omega$, [rad/s]')
        plt.ylabel(r'$|\mathcal{I}|_{13}$')
        ...
        save_all_figures(f'OutputFigures_10Nov/{file}_p={p}', format='pdf')
        count += 1
